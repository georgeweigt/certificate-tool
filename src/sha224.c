...
hmac_sha224(uint8_t *key, int keylen, uint8_t *buf, int len, uint8_t *out)
{
	...
	sha224_with_key(pad, buf, len, hash);
	...
	sha224_with_key(pad, hash, 28, out);
}

void
sha224(uint8_t *buf, int len, uint8_t *out)
{
	int i, n, r;
	uint8_t block[64];
	uint32_t hash[8];
...
void
sha224_with_key(uint8_t *key, uint8_t *buf, int len, uint8_t *out)
{
	int i, n, r;
	uint8_t block[64];
	uint32_t hash[8];
...
void
sha224_hash_block(uint8_t *buf, uint32_t *hash)
{
	int t;
