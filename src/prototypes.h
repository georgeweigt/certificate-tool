...
int check_md5_signature(struct certinfo *p, uint8_t *z);
int check_sha1_signature(struct certinfo *p, uint8_t *z);
int check_sha224_signature(struct certinfo *p, uint8_t *z);
int check_sha256_signature(struct certinfo *p, uint8_t *z);
int check_sha384_signature(struct certinfo *p, uint8_t *z);
int check_sha512_signature(struct certinfo *p, uint8_t *z);
int check_ecdsa_signature(struct certinfo *p, struct certinfo *q, uint8_t *hash, int hashlen);
int ecdsa256_verify(struct certinfo *p, struct certinfo *q, uint8_t *hash, int hashlen);
...
int ecdsa384_verify(struct certinfo *p, struct certinfo *q, uint8_t *hash, int hashlen);
...
void ec_test384();
void ecdh_test();
uint8_t * encrypt_signature_rsa(struct certinfo *p, struct certinfo *q);
