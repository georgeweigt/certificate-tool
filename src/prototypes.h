...
int check_md5_signature(struct certinfo *p, uint8_t *buf);
int check_sha1_signature(struct certinfo *p, uint8_t *buf);
int check_sha224_signature(struct certinfo *p, uint8_t *buf);
int check_sha256_signature(struct certinfo *p, uint8_t *buf);
int check_sha384_signature(struct certinfo *p, uint8_t *buf);
int check_sha512_signature(struct certinfo *p, uint8_t *buf);
