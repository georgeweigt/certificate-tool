...
void ecdsa256_signature(struct keyinfo *key, uint8_t *hash, int len, uint8_t *sig);
...
void ecdsa384_signature(struct keyinfo *key, uint8_t *hash, int len, uint8_t *sig);
...
void rsa_decrypt(uint8_t *buf, int len, struct keyinfo *key);
